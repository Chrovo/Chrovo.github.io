...
function editButton() {
    ...
    if(htmlEl.classList.contains("dark")) {
        darkModeButton.className = "bg-gray-300 h-6 w-11 border-2 rounded-full cursor-pointer";
        ...
        dmDot.className = "translate-x-0 inline-block h-5 w-5 rounded-full bg-gray-500 shadow transition ease-in-out duration-200";
    }
}
